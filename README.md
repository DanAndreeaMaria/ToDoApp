...
A simple full-stack web application for task management, built to practice skills learned in the CS50x course. 
...
## Installation & Setup
  1. Clone the repository
     ```git clone https://github.com/DanAndreeaMaria/ToDoApp.git```
     ```cd ToDoApp```
